...
export default function NavbarDemo() {
  const navItems = [
    { name: "Home", link: "/reit#hero" },
    { name: "REIT Investments", link: "/reit#properties" },
    { name: "How It Works", link: "/reit#steps" },
    { name: "About Us", link: "/reit#about" },
    { name: "Contact", link: "/reit#footer" },
  ];
