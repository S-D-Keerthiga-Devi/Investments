  ...
  const reits = [
    {
      ...
      tenure: "Open-Ended",
      ownership: "Publicly Traded REIT"
    },
    {
      id: 2,
      name: "Urban Retail REIT",
      ...
      minInvestment: "₹10,000",
      tenure: "Long Term",
      ownership: "Retail Focused REIT"
    },
    {
      id: 3,
      name: "Logistics Growth REIT",
      location: "NCR, Pune, Chennai",
      type: "Industrial REIT",
      image: "https://images.unsplash.com/photo-1605902711622-cfb43c4437b5?w=500&h=300&fit=crop",
      roi: "9.1%",
      rating: 5,
      badge: "bg-orange-600",
      minInvestment: "₹10,000",
      tenure: "Open-Ended",
      ownership: "Logistics & Warehousing REIT"
    },    
    {
      id: 4,
      name: "Tech Park REIT",
      ...
      type: "Office REIT",
      image: "https://images.unsplash.com/photo-1593642532973-d31b6557fa68?w=500&h=300&fit=crop",
      roi: "8.9%",
      rating: 4,
      badge: "bg-purple-700",
      minInvestment: "₹10,000",
      tenure: "Long Term",
      ownership: "Office Space REIT"
    }
  ];
      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="max-w-3xl mx-auto text-center mb-8">
          <div className="inline-flex items-center space-x-2 bg-blue-50 border border-blue-100 rounded-full px-3 py-1 mb-3">
            <span className="text-xs font-semibold text-blue-900">Top Performing REITs</span>
          </div>
          <h2 className="text-3xl font-bold text-blue-900 mb-2">
            Invest in High-Quality REIT Portfolios
          </h2>
          <p className="text-sm text-gray-600">
            Diversify your real estate exposure with trusted, high-yield REITs offering steady returns and liquidity.
          </p>
        </div>
