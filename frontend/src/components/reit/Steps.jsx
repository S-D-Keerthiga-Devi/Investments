...
export default function Steps() {
  ...
  const steps = [
    {
      title: "Discover REITs",
      icon: <Building2 className="w-5 h-5" />,
      text: "Explore top-performing portfolios"
    },
    {
      title: "Verify & Invest",
      icon: <FileText className="w-5 h-5" />,
      text: "Complete KYC and start investing"
    },
    {
      title: "Track Performance",
      icon: <PieChart className="w-5 h-5" />,
      text: "Monitor your REIT portfolio in real time"
    },
    {
      title: "Earn & Withdraw",
      icon: <Wallet className="w-5 h-5" />,
      text: "Enjoy regular income and flexible exits"
    }
  ];
    ...
    <div className="bg-white py-6 px-4">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold text-blue-900 mb-2 text-center">
          Investing in REITs Made Simple
        </h2>
