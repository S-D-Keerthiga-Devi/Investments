        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center min-h-[60vh] py-8">
          ...
          <div className="relative z-10 space-y-4">
            ...
            <p className="text-base text-gray-600 leading-relaxed max-w-lg">
              Invest in premium commercial spaces through fractional ownership, REITs, or venture-backed opportunities.
            </p>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-gray-200">
              <div>
                <p className="text-xl font-bold text-blue-900">14.2%</p>
                <p className="text-xs text-gray-600 mt-1">Avg. Annual ROI</p>
              </div>
              <div>
                <p className="text-xl font-bold text-blue-900">5,000+</p>
                <p className="text-xs text-gray-600 mt-1">Happy Investors</p>
              </div>
              <div>
                <p className="text-xl font-bold text-blue-900">$150M</p>
