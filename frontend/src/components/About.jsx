      ...
      <section className="bg-white py-24 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <div className="inline-block mb-4">
            <span className="text-sm font-semibold text-blue-900 uppercase tracking-wider bg-blue-50 px-4 py-2 rounded-full">
              About Us
            </span>
          </div>
          <h1 className="text-6xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-900 via-indigo-800 to-blue-900 bg-clip-text text-transparent leading-tight">
            About FractionVest
          </h1>
          ...
          <div className="mt-8 flex justify-center">
            <div className="h-1 w-24 bg-gradient-to-r from-blue-900 to-indigo-800 rounded-full"></div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {investmentTypes.map((type, index) => (
              ...
              >
                <div className={`${type.bgColor} p-6 flex justify-center`}>
                  ...
                  <ul className="space-y-3">
                    {type.features.map((feature, idx) => (
                      <li key={idx} className="flex items-start">
                        <svg 
                          className="w-5 h-5 text-blue-900 mr-2 mt-0.5 flex-shrink-0" 
                          fill="currentColor" 
                          viewBox="0 0 20 20"
                        >
                          <path 
