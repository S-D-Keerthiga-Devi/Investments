...
import { Building2, Wallet, LineChart, TrendingUp } from 'lucide-react';
  ...
  const steps = [
    {
      ...
      text: "Explore curated real estate options"
    },
    {
      title: "Invest Fractionally",
      icon: <Wallet className="w-5 h-5" />,
      text: "Start investing with small amounts"
    },
    {
      title: "Track Performance",
      icon: <LineChart className="w-5 h-5" />,
      text: "Monitor your portfolio and returns"
    },
    {
      title: "Earn Passive Income",
      icon: <TrendingUp className="w-5 h-5" />,
      text: "Receive rental income and capital gains"
    }
  ];
    ...
    <div className="bg-white py-6 px-4">
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl font-bold text-blue-900 mb-2 text-center">
          Start Fractional Investing in 4 Easy Steps
        </h2>
        ...
        <div className="mt-6 text-center">
          <button onClick={()=> navigate('#properties')} className="bg-[#1e3a8a] text-white px-5 py-2 rounded-md text-sm font-medium hover:bg-[#1e40af] transition-colors">
            Start Investing
          </button>
        </div>
      </div>
